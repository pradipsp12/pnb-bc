...
// ─── PDF: Upload to Google Shared Drive ──────────────────────────────────────
// Service accounts CANNOT upload to personal Google Drive (no quota).
// Solution: Use a Google Shared Drive (Team Drive) where service accounts
// are full members and CAN store files using the shared drive's quota.
//
// Setup steps (one-time):
// 1. Go to drive.google.com → Left sidebar → "Shared drives" → New
// 2. Name it "PNB Forms"
// 3. Click the shared drive → Manage members
// 4. Add your service account email as "Content manager" or "Manager"
// 5. Copy the Shared Drive ID from the URL:
//    https://drive.google.com/drive/u/0/folders/THIS_IS_SHARED_DRIVE_ID
// 6. Add to .env.local: GOOGLE_SHARED_DRIVE_ID=THIS_IS_SHARED_DRIVE_ID
